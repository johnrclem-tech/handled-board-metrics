...
function getPayloadConfigFromPayload(
  ...
  if (
    ...
    typeof (payloadPayload as Record<string, unknown>).dataKey === "string" &&
    (payloadPayload as Record<string, unknown>).dataKey as string in config
  ) {
    configLabelKey = (payloadPayload as Record<string, unknown>).dataKey as string
  }
