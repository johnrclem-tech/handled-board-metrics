            ...
            <Card key={kpi.title}>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <div className="flex h-8 w-8 items-center justify-center rounded-md bg-chart-2/15">
                  <kpi.icon className="h-4 w-4 text-chart-2" />
                </div>
              </CardHeader>
              <CardContent>
            ...
            <ResponsiveContainer width="100%" height={350}>
              <ComposedChart data={dataset} margin={{ top: 15, right: 20, left: 15, bottom: 5 }}>
                ...
                <YAxis
                  ...
                  tick={{ fontSize: 11 }}
                  width={55}
                  label={{ value: "Revenue ($)", angle: -90, position: "center", dx: -35, style: { fontSize: 13, fontWeight: 600, fill: "hsl(var(--muted-foreground))" } }}
                />
                <YAxis
                  yAxisId="right"
                  orientation="right"
